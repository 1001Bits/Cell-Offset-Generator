...
// .fco — Fallout Cell Offset. Layout matches WallSoGB's NVSE format exactly,
// so .fco files written by the FNV mod, this F4SE port, and the SKSE port
// share inspection tooling.
//
